	...
	<body>
			<?php require_once('navbar.php'); ?>
			  ...
			  <div class="container">
			  	...
			  	<h2 class="grey-text">  <i class="medium material-icons prefix">warning</i> Oups ... </h2>
			  	<p>Nous n'avons pas pu enregistrer votre compte car cet identifiant est déjà utilisé. </p>
			  	<p> Si vous avez des questions n'hésitez pas à nous contacter :</p>
			  	<p class="center"><a href="mailto:david.ringayen@icloud.com"><i class="small material-icons">mail</i></a></p>
			</div>
